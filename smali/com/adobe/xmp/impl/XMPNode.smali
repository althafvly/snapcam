...
.method private dumpNode(Ljava/lang/StringBuffer;ZII)V
    ...
    :cond_4
    :goto_1
    iget-object v1, p0, Lcom/adobe/xmp/impl/XMPNode;->value:Ljava/lang/String;
    ...
    invoke-virtual {v1, v3}, Lcom/adobe/xmp/options/PropertyOptions;->containsOneOf(I)Z
    ...
    invoke-virtual {v1}, Lcom/adobe/xmp/options/PropertyOptions;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/adobe/xmp/options/PropertyOptions;->getOptionsString()Ljava/lang/String;
    ...
    new-array v2, v2, [Lcom/adobe/xmp/impl/XMPNode;
    ...
    .line 766
    .local v1, "quals":[Lcom/adobe/xmp/impl/XMPNode;
    move v2, v0
    ...
    .line 783
    .end local v1    # "quals":[Lcom/adobe/xmp/impl/XMPNode;
    .end local v2    # "i":I
    :cond_9
    if-eqz p2, :cond_b
    ...
    invoke-direct {v2, p1, p2, v3, v4}, Lcom/adobe/xmp/impl/XMPNode;->dumpNode(Ljava/lang/StringBuffer;ZII)V
...
.method private find(Ljava/util/List;Ljava/lang/String;)Lcom/adobe/xmp/impl/XMPNode;
    ...
    .line 882
    .local v1, "child":Lcom/adobe/xmp/impl/XMPNode;
    ...
    .line 886
    .end local v1    # "child":Lcom/adobe/xmp/impl/XMPNode;
    :cond_0
    goto :goto_0
...
.method public clone()Ljava/lang/Object;
    ...
    .line 433
    .local v0, "newOptions":Lcom/adobe/xmp/options/PropertyOptions;
    goto :goto_0

    .line 429
    .end local v0    # "newOptions":Lcom/adobe/xmp/options/PropertyOptions;
    :catch_0
    move-exception v0
...
.method public cloneSubtree(Lcom/adobe/xmp/impl/XMPNode;)V
    ...
    invoke-virtual {p1, v2}, Lcom/adobe/xmp/impl/XMPNode;->addChild(Lcom/adobe/xmp/impl/XMPNode;)V
    ...
    invoke-virtual {p1, v2}, Lcom/adobe/xmp/impl/XMPNode;->addQualifier(Lcom/adobe/xmp/impl/XMPNode;)V
    :try_end_0
    .catch Lcom/adobe/xmp/XMPException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public sort()V
    ...
    .line 652
    .local v0, "quals":[Lcom/adobe/xmp/impl/XMPNode;
    const/4 v1, 0x0
    ...
    .line 664
    iget-object v3, p0, Lcom/adobe/xmp/impl/XMPNode;->qualifier:Ljava/util/List;
    ...
    .line 674
    .end local v0    # "quals":[Lcom/adobe/xmp/impl/XMPNode;
    .end local v1    # "j":I
    .end local v2    # "sortFrom":I
    .end local v3    # "it":Ljava/util/ListIterator;
    :cond_2
    invoke-virtual {p0}, Lcom/adobe/xmp/impl/XMPNode;->hasChildren()Z
