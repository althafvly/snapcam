...
.method protected varargs doInBackground([Ljava/lang/Void;)Landroid/net/Uri;
    ...
    .line 370
    iget-object v1, p0, Lcom/android/camera/MediaSaveService$ImageSaveTask;->data:[B

    const/4 v2, 0x0

    iget-object v3, p0, Lcom/android/camera/MediaSaveService$ImageSaveTask;->data:[B
    ...
    iput v1, p0, Lcom/android/camera/MediaSaveService$ImageSaveTask;->width:I

    .line 372
    iget v1, v0, Landroid/graphics/BitmapFactory$Options;->outHeight:I

    iput v1, p0, Lcom/android/camera/MediaSaveService$ImageSaveTask;->height:I

    .line 374
    .end local v0    # "options":Landroid/graphics/BitmapFactory$Options;
    :cond_1
    iget-object v2, p0, Lcom/android/camera/MediaSaveService$ImageSaveTask;->resolver:Landroid/content/ContentResolver;

    iget-object v3, p0, Lcom/android/camera/MediaSaveService$ImageSaveTask;->title:Ljava/lang/String;

    iget-wide v4, p0, Lcom/android/camera/MediaSaveService$ImageSaveTask;->date:J

    iget-object v6, p0, Lcom/android/camera/MediaSaveService$ImageSaveTask;->loc:Landroid/location/Location;

    iget v7, p0, Lcom/android/camera/MediaSaveService$ImageSaveTask;->orientation:I

    iget-object v8, p0, Lcom/android/camera/MediaSaveService$ImageSaveTask;->exif:Lcom/android/camera/exif/ExifInterface;

    iget-object v9, p0, Lcom/android/camera/MediaSaveService$ImageSaveTask;->data:[B

    iget v10, p0, Lcom/android/camera/MediaSaveService$ImageSaveTask;->width:I

    iget v11, p0, Lcom/android/camera/MediaSaveService$ImageSaveTask;->height:I

    iget-object v12, p0, Lcom/android/camera/MediaSaveService$ImageSaveTask;->pictureFormat:Ljava/lang/String;
