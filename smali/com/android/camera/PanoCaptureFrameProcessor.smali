...
.method public constructor <init>(Landroid/util/Size;Landroid/app/Activity;Lcom/android/camera/PanoCaptureUI;Lcom/android/camera/PanoCaptureModule;)V
    ...
    iput-boolean v0, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mIsPanoActive:Z
    ...
    iput-object v1, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mPanoSwitchLock:Ljava/lang/Object;
    ...
    iput-object v1, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mAllocationLock:Ljava/lang/Object;
    ...
    iget-object v3, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mRs:Landroid/renderscript/RenderScript;
    ...
    iput-object v3, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mInputAllocation:Landroid/renderscript/Allocation;
    ...
    iget-object v5, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mRs:Landroid/renderscript/RenderScript;
    ...
    iput-object v4, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mARGBOutputAllocation:Landroid/renderscript/Allocation;
    ...
    const-string v5, "PanoCapture_FrameProcessor"

    invoke-direct {v4, v5}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    iput-object v4, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mProcessingThread:Landroid/os/HandlerThread;
    ...
    iget-object v5, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mProcessingThread:Landroid/os/HandlerThread;
    ...
    iput-object v4, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mProcessingHandler:Landroid/os/Handler;

    .line 101
    :cond_0
    new-instance v4, Lcom/android/camera/PanoCaptureFrameProcessor$ProcessingTask;

    invoke-direct {v4, p0}, Lcom/android/camera/PanoCaptureFrameProcessor$ProcessingTask;-><init>(Lcom/android/camera/PanoCaptureFrameProcessor;)V

    iput-object v4, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mTask:Lcom/android/camera/PanoCaptureFrameProcessor$ProcessingTask;

    .line 102
    iget-object v4, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mInputAllocation:Landroid/renderscript/Allocation;

    iget-object v5, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mTask:Lcom/android/camera/PanoCaptureFrameProcessor$ProcessingTask;
    ...
    .line 103
    iput-boolean v0, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mIsAllocationEverUsed:Z

    .line 104
    .end local v2    # "yuvTypeBuilder":Landroid/renderscript/Type$Builder;
...
.method public changePanoStatus(ZZ)V
    ...
    .line 144
    :try_start_0
    iget-object v1, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mUI:Lcom/android/camera/PanoCaptureUI;

    invoke-virtual {v1}, Lcom/android/camera/PanoCaptureUI;->isPanoCompleting()Z
    ...
    .line 148
    iget-boolean v1, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mIsPanoActive:Z
    ...
    invoke-virtual {v1, v2, p2}, Lcom/android/camera/PanoCaptureUI;->onFrameAvailable(Landroid/graphics/Bitmap;Z)V
...
.method public clear()V
    ...
    .line 112
    :try_start_0
    iget-object v1, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mInputAllocation:Landroid/renderscript/Allocation;
    ...
    .line 113
    iget-boolean v1, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mIsAllocationEverUsed:Z

    if-eqz v1, :cond_1

    .line 114
    iget-object v1, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mRs:Landroid/renderscript/RenderScript;
    ...
    .line 116
    iget-object v1, p0, Lcom/android/camera/PanoCaptureFrameProcessor;->mARGBOutputAllocation:Landroid/renderscript/Allocation;
...
.method public getInputSurface()Landroid/view/Surface;
    ...
    invoke-virtual {v1}, Landroid/renderscript/Allocation;->getSurface()Landroid/view/Surface;
