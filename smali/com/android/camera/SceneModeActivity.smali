...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/camera/SceneModeActivity;->setContentView(I)V
    ...
    iput-object v1, p0, Lcom/android/camera/SceneModeActivity;->mSettingsManager:Lcom/android/camera/SettingsManager;

    .line 101
    iget-object v1, p0, Lcom/android/camera/SceneModeActivity;->mSettingsManager:Lcom/android/camera/SettingsManager;
    ...
    iput v1, p0, Lcom/android/camera/SceneModeActivity;->mCurrentScene:I
    ...
    invoke-virtual {v1, v3}, Lcom/android/camera/SettingsManager;->getEntries(Ljava/lang/String;)[Ljava/lang/CharSequence;

    move-result-object v1

    iput-object v1, p0, Lcom/android/camera/SceneModeActivity;->mEntries:[Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v3, v2}, Lcom/android/camera/SettingsManager;->getResource(Ljava/lang/String;I)[I

    move-result-object v1

    iput-object v1, p0, Lcom/android/camera/SceneModeActivity;->mThumbnails:[I

    .line 108
    iget-object v1, p0, Lcom/android/camera/SceneModeActivity;->mThumbnails:[I

    array-length v1, v1

    iput v1, p0, Lcom/android/camera/SceneModeActivity;->mNumElement:I

    .line 109
    iget v1, p0, Lcom/android/camera/SceneModeActivity;->mNumElement:I

    iget v2, p0, Lcom/android/camera/SceneModeActivity;->mElemPerPage:I

    div-int/2addr v1, v2

    .line 110
    .local v1, "pages":I
    iget v2, p0, Lcom/android/camera/SceneModeActivity;->mNumElement:I

    iget v3, p0, Lcom/android/camera/SceneModeActivity;->mElemPerPage:I
    ...
    .line 111
    :cond_1
    iput v1, p0, Lcom/android/camera/SceneModeActivity;->mNumPage:I

    .line 113
    new-instance v2, Lcom/android/camera/MyPagerAdapter;

    invoke-direct {v2, p0}, Lcom/android/camera/MyPagerAdapter;-><init>(Lcom/android/camera/SceneModeActivity;)V

    iput-object v2, p0, Lcom/android/camera/SceneModeActivity;->mAdapter:Lcom/android/camera/MyPagerAdapter;

    .line 115
    const v2, 0x7f0d00db

    invoke-virtual {p0, v2}, Lcom/android/camera/SceneModeActivity;->findViewById(I)Landroid/view/View;

    move-result-object v2

    check-cast v2, Landroid/support/v4/view/ViewPager;

    iput-object v2, p0, Lcom/android/camera/SceneModeActivity;->mPager:Landroid/support/v4/view/ViewPager;

    .line 116
    iget-object v2, p0, Lcom/android/camera/SceneModeActivity;->mPager:Landroid/support/v4/view/ViewPager;
    ...
    iput-object v2, p0, Lcom/android/camera/SceneModeActivity;->mCloseButton:Landroid/view/View;

    .line 120
    iget-object v2, p0, Lcom/android/camera/SceneModeActivity;->mCloseButton:Landroid/view/View;

    new-instance v3, Lcom/android/camera/SceneModeActivity$1;

    invoke-direct {v3, p0}, Lcom/android/camera/SceneModeActivity$1;-><init>(Lcom/android/camera/SceneModeActivity;)V

    invoke-virtual {v2, v3}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 127
    iget-object v2, p0, Lcom/android/camera/SceneModeActivity;->mAdapter:Lcom/android/camera/MyPagerAdapter;

    invoke-virtual {v2}, Lcom/android/camera/MyPagerAdapter;->getCount()I
    ...
    invoke-direct {v4, v2}, Lcom/android/camera/SceneModeActivity$PageItems;-><init>(I)V
