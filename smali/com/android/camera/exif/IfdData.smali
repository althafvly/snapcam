...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 134
    :cond_1
    instance-of v2, p1, Lcom/android/camera/exif/IfdData;
    ...
    check-cast v2, Lcom/android/camera/exif/IfdData;

    .line 136
    .local v2, "data":Lcom/android/camera/exif/IfdData;
    invoke-virtual {v2}, Lcom/android/camera/exif/IfdData;->getId()I

    move-result v3

    iget v4, p0, Lcom/android/camera/exif/IfdData;->mIfdId:I

    if-ne v3, v4, :cond_5

    invoke-virtual {v2}, Lcom/android/camera/exif/IfdData;->getTagCount()I
    ...
    .line 137
    invoke-virtual {v2}, Lcom/android/camera/exif/IfdData;->getAllTags()[Lcom/android/camera/exif/ExifTag;
    ...
    .line 139
    .local v6, "tag":Lcom/android/camera/exif/ExifTag;
    invoke-virtual {v6}, Lcom/android/camera/exif/ExifTag;->getTagId()S

    move-result v7

    invoke-static {v7}, Lcom/android/camera/exif/ExifInterface;->isOffsetTag(S)Z
    ...
    .line 142
    :cond_2
    iget-object v7, p0, Lcom/android/camera/exif/IfdData;->mExifTags:Ljava/util/Map;
    ...
    check-cast v7, Lcom/android/camera/exif/ExifTag;

    .line 143
    .local v7, "tag2":Lcom/android/camera/exif/ExifTag;
    invoke-virtual {v6, v7}, Lcom/android/camera/exif/ExifTag;->equals(Ljava/lang/Object;)Z
    ...
    .line 138
    .end local v6    # "tag":Lcom/android/camera/exif/ExifTag;
    .end local v7    # "tag2":Lcom/android/camera/exif/ExifTag;
    :cond_3
    :goto_1
    ...
    .line 150
    .end local v2    # "data":Lcom/android/camera/exif/IfdData;
